...
import { getProfitsStatsByWeek } from "../../../actions";
...
export default (props)=> {
  ...
  React.useEffect(() => {
    setLoading(true);
    getProfitsStatsByWeek(props.type)
      .then((res) => {
        console.log(res);
        setData(res);
        setError(false);
      ...
      <Card chart>
        <CardHeader color="warning">
          {loading ? (
            ...
            listener={barOptions.animation}
            responsiveOptions={barOptions.responsiveOptions}
        ...
        <CardBody>
          {loading ? (
            ...
            <>
              ...
              <p className={classes.cardCategory}>ربح هذا الأسبوع</p>
            </>
          )}
        </CardBody>
