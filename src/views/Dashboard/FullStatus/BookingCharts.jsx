...
import { getBookingsStatsByWeek } from "../../../actions";
...
export default function BookingCharts(props) {
  ...
  React.useEffect(() => {
    setLoading(true);
    getBookingsStatsByWeek(props.type)
      .then((res) => {
        console.log(res);
        setData(res);
        setError(false);
        ...
        <CardBody>
          {loading ? (
            ...
            <>
              ...
              <p className={classes.cardCategory}>مرات الحجز هذا الأسبوع</p>
            </>
          )}
        </CardBody>
